========================================================================
    KONSOLENANWENDUNG: VectorsAndTriangles-Projektübersicht
========================================================================

Diese VectorsAndTriangles-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die VectorsAndTriangles-Anwendung besteht.


VectorsAndTriangles.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen VectorsAndTriangles.pch sowie eine vorkompilierte 
